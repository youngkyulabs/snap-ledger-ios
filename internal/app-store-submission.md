...
```
• 지출을 저장했을 때 그 카테고리가 이번 달 예산의 80%를 넘었거나 초과하면 시스템 알림으로 알려줘요. 남은 금액(또는 초과 금액)을 한눈에 볼 수 있고, 알림을 받으려면 알림 권한이 필요해요.
...
| 1.2.1 | 2026-06-28 갱신 | 검토 저장 시 예산 임계(80%/초과) 로컬 알림 추가 |
